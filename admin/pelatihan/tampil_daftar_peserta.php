<?php 
include '../../koneksi.php';
$s_pendamping = mysql_query("SELECT * FROM tb_pendaftaran inner join tb_pelatihan inner join tb_jenispelatihan where id_jenispelatihan = '".addslashes($_POST['post'])."' AND status='diterima'") or die(mysql_error());
