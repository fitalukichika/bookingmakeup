                  ...
                  <div class="col-xs-3">
                    <div class="form-group">
                      <select class="form-control" name="jns_pelatihan">
                        <option>Pilih*</option>
                        <?php
                        $q_jns = mysql_query("SELECT * FROM tb_jenispelatihan ORDER BY nama_pelatihan") or die(mysql_error());
              ...
              <table id="datatable" class="table table-striped table-bordered">
                ...
                <tbody>
                  ...
                  if (isset($_POST['btncari'])) {
                    $query = mysql_query("SELECT * FROM tb_pendaftaran,tb_periode,tb_jenispelatihan WHERE tb_pendaftaran.id_jenispelatihan=tb_jenispelatihan.id_jenispelatihan and tb_pendaftaran.id_periode=tb_periode.id_periode and (tb_pendaftaran.status='diterima' AND tb_jenispelatihan.id_jenispelatihan='".$_POST['jns_pelatihan']."')");
                  }else{
                    $query = mysql_query("SELECT * FROM tb_pendaftaran,tb_periode,tb_jenispelatihan WHERE tb_pendaftaran.id_jenispelatihan=tb_jenispelatihan.id_jenispelatihan and tb_pendaftaran.id_periode=tb_periode.id_periode and tb_pendaftaran.status='diterima'");
                  }
                  //====================================================================================
