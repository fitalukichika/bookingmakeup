  ...
  <section class="content">
      ...
      <div class="row">
            ...
            <!-- /.box-header -->
              ...
              <a href="?page=data_pesertaditolak" class="btn btn-dark btn-flat margin"><span class="fa fa-remove (alias)"></span> Data Peserta Ditolak</a>
              <br><br>
               <!-- =================================  Pencarian ==================================  -->
              <div class="row">
                <form method="post">
