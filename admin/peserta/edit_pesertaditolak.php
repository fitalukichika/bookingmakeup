...
if (isset($_POST['simpan'])) {
        ...
        if ($simpan) {
                ...
                <a href='?page=data_pesertaditolak' class='close' data-dismiss='alert'>
                &times;
                </a> Edit Data Berhasil
                </div>";

                echo "<meta http-equiv='refresh' content='10; url=?page=data_pesertaditolak'>";
            ...
            <form class="form-horizontal" method="post"  enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="no_ktp" placeholder="No ktp" value="<?php echo $data['no_ktp']; ?>"  readonly required>
                  </div>
                </div>
                <div class="form-group">
                ...
                <!--<div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select class="form-control" name="id_jenispelatihan" value="<?php echo $data['nama_pelatihan']; ?>">
                      ...
                      <?php
                        $s_nama_pelatihan = mysql_query("SELECT * FROM tb_jenispelatihan") or die(mysql_error());
              ...
              <div class="box-footer">
                <a href="?page=data_pesertaditolak" class="btn btn-default">Batal</a>
