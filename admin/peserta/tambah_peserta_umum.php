...
if (isset($_POST['simpan'])) 
{
  ...
  $lihat = mysql_query("SELECT * from tb_pendaftaran where no_ktp = '$no_ktp' or username = '$username'");
  ...
  $update_kuota=mysql_query("UPDATE tb_pelatihan SET kuota = kuota-1 WHERE id_pelatihan='$nama_pelatihan'") or die(mysql_error());
...
function cekUsername()
{
    ...
    $.ajax({
        url:"ajax/cek.php?act=cekUsername&username="+username,
...
<body> <blockquote>Untuk Mengikuti Pelatihan IKM <br>
Silahkan Lakukan Proses Pendaftaran Terlebih Dahulu</blockquote></body>
</html>
             
       <table align="center" cellpadding="2" cellspacing="10" > 
     <tr>
      <td colspan="3" align="center" width="700" height="40" bgcolor="#CCCC99"><b><font size="+2" color="#600">PENDAFTARAN</font></b>
        </td>
     </tr>
   ...
   <!-- <tr>
    ...
    <tr>
        ...
        <td width="66%">
          <div class="col-sm-10">
          <textarea class="form-control" cols="40" rows="3" placeholder="Enter ..." name="alamat" required></textarea>    
          </div> 
       </td>
       </div>
    </tr>
    ...
    <tr>
        ...
        <td width="66%">
          <div class="col-sm-10">
          <input type="text" class="form-control" size="30" name="no_hp" placeholder="Nomer Telepon" onkeypress="return hanyaAngka(event, false)" maxlength="12" required>     
          </div> 
       </td>
       </div>
    </tr>
    ...
    <tr>
        ...
        <td width="66%">
          ...
          <select class="form-control" name="nama_pelatihan">
                  <option>Pilih*</option>
                  <?php
                    $s_pelatihan = mysql_query("SELECT * FROM tb_jenispelatihan left join tb_pelatihan on tb_jenispelatihan.id_jenispelatihan=tb_pelatihan.id_jenispelatihan WHERE kuota > 0 ") or die(mysql_error());
                    while ($h_pelatihan = mysql_fetch_array($s_pelatihan)) {
                    echo "<option value='$h_pelatihan[id_pelatihan]'>$h_pelatihan[nama_pelatihan]</option>"; 
                  }
                  ?>
          </select>
          </div>
