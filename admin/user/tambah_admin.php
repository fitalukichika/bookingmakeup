...
if (isset($_POST['simpan'])) 
{
  if (@$_FILES['foto']['name']) 
  {
    ...
    $simpan = mysql_query("INSERT INTO tb_user VALUES('$id_user','$nik','$nama','$jekel','$alamat','$no_hp', '$username', '$password', '$nama_foto', '$status')");

    // $simpan2 = mysql_query("INSERT INTO tb_hubung VALUES ('$id_user','$jns_magang')") or die(mysql_error());
    ...
    if ($simpan) 
    {
      ...
      echo "<meta http-equiv='refresh' content='10; url=?page=data_user'>";
            ...
            <form class="form-horizontal" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="nik" placeholder="NIK" onkeypress="return hanyaAngka(event, false)" onkeyup="cekKtpPemilik()" maxlength="16" required>
                  </div>
                </div>
                <div class="form-group">
                ...
                <!-- <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <select class="form-control" name="jns_magang">
                      <option>Pilih</option>
                      <?php
                        $sql = mysql_query("SELECT id_jenispelatihan, nama_pelatihan FROM tb_jenispelatihan ORDER BY nama_pelatihan") or die(mysql_error());
                        while ($dt_mg  =mysql_fetch_array($sql)) {
                      ?>
