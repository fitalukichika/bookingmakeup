                ...
                <div class="col-xs-12">
                  <div class="box">
                    ...
                    <div class="box-body">
                      ...
                      <?php
                        $thn = date('Y');
                        $query = mysql_query("SELECT * FROM tb_periode WHERE tahun='$thn' order by tgl_mulai DESC") or die(mysql_error());
                        $datane = mysql_fetch_array($query);
                      ?>
                     <table border="" cellspacing="1" cellpadding="1" width="90%" align="center">
                        <caption> <h3>Periode Pendaftaran di Buka: <?php echo date('d F Y',  strtotime($datane['tgl_mulai'])) .' sampai '.date('d F Y',  strtotime($datane['tgl_selesai'])); ?></h3> <br/><br /></caption>
                        ...
                        <tbody>
                          ...
                          //$tampilkan = mysql_query("SELECT * FROM tb_pelatihan NATURAL JOIN tb_jenispelatihan on tb_pelatihan.id_jenispelatihan=tb_jenispelatihan.id_jenispelatihan WHERE kuota > 0 and tb_pelatihan.id_pelatihan is null");
                          $no = 1;
