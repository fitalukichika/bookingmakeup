...
if (isset($_POST['simpan'])) {
        ...
        if ($foto_diri == "" && $tdi == "") {
             $simpan = mysql_query("UPDATE tb_pendaftaran SET id_peserta='$id_peserta', no_ktp='$no_ktp', nama_peserta='$nama_peserta', jekel='$jekel', alamat='$alamat', no_hp='$no_hp', nama_perusahaan='$nama_perusahaan', produk='$produk', id_pelatihan='$id_jenispelatihan', username='$username', password='$password', status='$status', id_periode='$id_periode' WHERE id_peserta='$id'") or die(mysql_error());
        }elseif ($tdi == "") {
            ...
            $simpan = mysql_query("UPDATE tb_pendaftaran SET id_peserta='$id_peserta', no_ktp='$no_ktp', nama_peserta='$nama_peserta', jekel='$jekel', alamat='$alamat', no_hp='$no_hp', nama_perusahaan='$nama_perusahaan', produk='$produk', id_pelatihan='$id_jenispelatihan', tdi='$tdiup', username='$username', password='$password', status='$status', id_periode='$id_periode' WHERE id_peserta='$id'") or die(mysql_error());
        }else{
