...
if (isset($_POST['simpan'])) {
        ...
        $simpan = mysql_query("UPDATE tb_artikel SET judul='$judul', isi='$isi', kategori='$kategori', tanggal='$tanggal' WHERE id_artikel='$id_artikel'") or die(mysql_error());
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select class="form-control" name="kategori">
                      ...
                      <option value="berita" <?php if ($data['kategori']=="berita") {echo 'selected';} ?>>Berita</option>
                      <option value="informasi"  <?php if ($data['kategori']=="informasi") {echo 'selected';} ?>>Informasi</option>
                    </select>
                  </div>
                </div>
                <div class="form-group">
