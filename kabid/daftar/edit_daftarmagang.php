...
if (isset($_POST['simpan'])) {
        ...
        $simpan = mysql_query("UPDATE tb_jenismagang SET nama_magang='$nama_magang', tempat='$tempat', jadwal='$jadwal', kuota='$kuota' WHERE id_magang='$id_magang'") or die(mysql_error());
