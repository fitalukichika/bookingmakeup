          ...
          <div class="box">
            ...
            <div class="box-body table-responsive">    
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php
                    $query = mysql_query("SELECT *, COUNT(id_peserta) as jumlah FROM tb_user NATURAL join tb_magang NATURAL JOIN tb_jenismagang LEFT JOIN tb_pendaftaran on tb_pendaftaran.id_magang=tb_jenismagang.id_magang WHERE 1 GROUP by tb_jenismagang.id_magang");
                    $no = 1;
