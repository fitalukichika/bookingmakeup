          ...
          <div class="table-responsive" >
            <table class="table table-hover table-bordered table-striped" style="padding: 10px">
              ...
              <tbody class="tampil_daftar_peserta">
                <?php 
                $s_pembimbing = mysql_query("SELECT * FROM tb_pendaftaran A, tb_jenismagang B, tb_penilaian C WHERE A.id_magang=B.id_magang AND C.id_magang=B.id_magang AND C.id_peserta=A.id_peserta AND C.id_magang = '".addslashes($_GET['id'])."'") or die(mysql_error());
