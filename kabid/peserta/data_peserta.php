          ...
          <div class="box">
            ...
            <div class="box-body  table-responsive">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php
                    $query = mysql_query("SELECT * FROM tb_pendaftaran,tb_periode,tb_jenismagang WHERE tb_pendaftaran.id_magang=tb_jenismagang.id_magang and tb_pendaftaran.id_periode=tb_periode.id_periode and tb_pendaftaran.status='diterima'");
                    $no = 1;
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <?php 
                                    //sms
                         $sql =mysql_query("SELECT no_telp FROM tb_pendaftaran  ") or die (mysql_error());
