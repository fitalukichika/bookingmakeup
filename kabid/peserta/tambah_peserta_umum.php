...
if (isset($_POST['simpan'])) 
{
  ...
  $update_kuota=mysql_query("UPDATE tb_jenismagang SET kuota=kuota-1 WHERE id_magang='$nama_magang'") or die(mysql_error());
        ...
        <form class="form-horizontal" method="post" enctype="multipart/form-data">
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" id="no_ktp" name="no_ktp" max="16" placeholder="No KTP Anda" onkeypress="return hanyaAngka(event, false)" onkeyup="cekKtpPemilik()" required>
              </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="nama_peserta" placeholder="Nama Lengkap Anda" required>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="usaha" placeholder="Usaha Anda Saat ini" required>
              </div>
            </div>
            <div class="form-group">
              <label for="inputPassword3" class="col-sm-2 control-label">Hasil Produk</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" name="hasil_produk" placeholder="Hasil Produk Anda" required>
              </div>
            </div>
            <div class="form-group">
              <label for="inputPassword3" class="col-sm-2 control-label">Alamat</label>
              <div class="col-sm-10">
                <textarea class="form-control" rows="3" placeholder="(Penting...!) Alamat Lengkap Anda" name="alamat" required></textarea>
              </div>
            </div>
            <div class="form-group">
              <label for="inputPassword3" class="col-sm-2 control-label">No. Telepon </label>
              <div class="col-sm-10">
                <input type="text" class="form-control" name="no_telp" placeholder="(Penting...!) Nomer Telepon Aktif" onkeypress="return hanyaAngka(event, false)" max="13" required>
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label">Nama Magang</label>
              <div class="col-sm-10">
                <select class="form-control" name="nama_magang" required>
                  <option>Pilih*</option>
                  <?php
                    $s_magang = mysql_query("SELECT tb_jenismagang.id_magang, tb_jenismagang.nama_magang FROM tb_jenismagang left join tb_magang on tb_jenismagang.id_magang=tb_magang.id_magang WHERE kuota > 0 and tb_magang.id_pemagangan is null") or die(mysql_error());
                    while ($h_magang = mysql_fetch_array($s_magang)) {
