...
// seperti sebelunya, kita membuat class anakan dari class FPDF
 class PDF extends FPDF{
  ...
  function Header(){
   //$this->Image('../src/img/kudus.png',5.5,1,1.5);
   ...
   //Tanggal Sekarang
    ...
    include "../../koneksi.php";
     ...
     while($data=mysql_fetch_array($sql)) {
      ...
      $this->Cell(12.5,4.5,'Yang diselenggarakan oleh Disnakerperinkopukm kota Kudus',0,0,'C');
      $this->Ln(0.6);
      ...
      $this->Cell(7.6,5, 'Kudus,' . ' ' . TanggalIndo($tglsekarang) ,0,0,'C');
     }
   
   $this->SetFont('times','B','11'); // font yang digunakan
   //$this->Cell(21,0.3,'UPT. BLK KUDUS',0,0,'C');
   $this->Ln(1.5);
