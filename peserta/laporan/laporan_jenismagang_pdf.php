<?php  
	...
	class FPDF_AutoWrapTable extends FPDF {
		...
		public function rptDetailData () {
			...
			$this->Ln(30);
			$this->SetFont("", "B", 12);
			$this->SetX($left); $this->Cell(0, 10, 'Laporan Data Jenis Magang ', 0, 1,'C');
			$this->Ln(10);
			...
			$this->SetX($left += 20); $this->Cell(120, $h, 'ID Jenis Magang', 1, 0, 'C',true);
			$this->SetX($left += 120); $this->Cell(150, $h, 'Nama Magang', 1, 0, 'C',true);
			$this->SetX($left += 150); $this->Cell(150, $h, 'Tempat', 1, 0, 'C',true);
			$this->SetX($left += 150); $this->Cell(150, $h, 'Jadwal', 1, 0, 'C',true);
			$this->SetX($left += 150); $this->Cell(290, $h, 'Kuota', 1, 0, 'C',true);
			// $this->SetX($left += 80); $this->Cell(80, $h, 'Nama magang', 1, 1, 'C',true);
			$this->Ln(25);
	 
			$this->SetFont('Arial','',9);
			$this->SetWidths(array(20,120,150,150,150,290));
	...
	$data = array();
	$query = "SELECT * from tb_jenismagang";
