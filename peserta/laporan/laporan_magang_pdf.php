<?php  
	...
	class FPDF_AutoWrapTable extends FPDF {
		...
		public function rptDetailData () {
			...
			$this->Ln(30);
			$this->SetFont("", "B", 12);
			$this->SetX($left); $this->Cell(0, 10, 'Laporan Data Magang ', 0, 1,'C');
			$this->Ln(10);
			...
			$this->SetX($left += 20); $this->Cell(120, $h, 'ID Pemagangan', 1, 0, 'C',true);
			$this->SetX($left += 120); $this->Cell(160, $h, 'Nama Magang', 1, 0, 'C',true);
			$this->SetX($left += 160); $this->Cell(150, $h, 'Tempat', 1, 0, 'C',true);
			$this->SetX($left += 150); $this->Cell(120, $h, 'Jadwal', 1, 0, 'C',true);
			$this->SetX($left += 120); $this->Cell(190, $h, 'Nama Pembimbing', 1, 0, 'C',true);
