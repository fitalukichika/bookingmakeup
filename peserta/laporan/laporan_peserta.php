...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-television" class="active"></i> Laporan Peserta</a></li>
      </ol>
    </section>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" method="post" action="laporan/laporan_peserta_pdf.php" target="_blank">
              <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <select class="form-control" name="id_magang">
                          ...
                          <?php
                            $s_magang = mysql_query("SELECT * FROM tb_jenismagang") or die(mysql_error());
