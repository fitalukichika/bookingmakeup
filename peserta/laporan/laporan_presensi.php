                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <select class="form-control" name="id_magang">
                          ...
                          <?php
                            $s_magang = mysql_query("select id_magang, nama_magang from tb_jenismagang NATURAL JOIN tb_magang NATURAL JOIN tb_presensi GROUP by id_magang") or die(mysql_error());
