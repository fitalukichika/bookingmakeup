              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select class="form-control cari_id_magang" name="id_magang" id="id_magang" onchange="changeValue(this.value)">
                    <?php 
                    $s_pembimbing = mysql_query("SELECT id_pembimbing, nama_pembimbing,tempat,jadwal FROM tb_pembimbing NATURAL join tb_magang natural join tb_jenismagang WHERE id_magang='".addslashes($_GET['id'])."' GROUP by id_magang") or die(mysql_error());
