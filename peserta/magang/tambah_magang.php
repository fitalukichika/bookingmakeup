            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <select class="form-control cari_id_magang" name="id_magang" id="id_magang" onchange="changeValue(this.value)">
                  ...
                  <?php 
                  $result = mysql_query("SELECT tb_magang.id_pemagangan, tb_jenismagang.id_magang, tb_jenismagang.nama_magang, tb_jenismagang.tempat,tb_jenismagang.jadwal FROM `tb_jenismagang` left join tb_magang on tb_jenismagang.id_magang=tb_magang.id_magang"); 
