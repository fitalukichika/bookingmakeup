          ...
          <div class="box">
            ...
            <div class="box-body table-responsive">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php
                    $query = mysql_query("SELECT tb_pembimbing.id_pembimbing, tb_pembimbing.nik,tb_pembimbing.nama_pembimbing,tb_pembimbing.jekel,tb_pembimbing.alamat,tb_pembimbing.no_telp,tb_pembimbing.foto FROM tb_pembimbing");
                    $no = 1;
