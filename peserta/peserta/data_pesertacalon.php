        ...
        <div class="col-xs-12">
            ...
            <!-- /.box-header -->
              ...
              <table id="datatable" class="table table-striped table-bordered">
                ...
                <tbody>
                  <?php
                    $query = mysql_query("SELECT * FROM tb_pendaftaran,tb_periode,tb_jenispelatihan WHERE tb_pendaftaran.id_jenispelatihan=tb_jenispelatihan.id_jenispelatihan and tb_pendaftaran.id_periode=tb_periode.id_periode and tb_pendaftaran.status='calon'");
                    $no = 1;
