        ...
        <div class="col-xs-12">
            ...
            <!-- /.box-header -->
              ...
              <br><br>
                ...
                <tbody>
                  <?php
                    $query = mysql_query("SELECT * FROM tb_pendaftaran,tb_periode,tb_jenispelatihan WHERE tb_pendaftaran.id_jenispelatihan=tb_jenispelatihan.id_jenispelatihan and tb_pendaftaran.id_periode=tb_periode.id_periode and tb_pendaftaran.status='ditolak'");
                    $no = 1;
