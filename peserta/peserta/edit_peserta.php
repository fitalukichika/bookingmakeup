...
if (isset($_POST['simpan'])) {
        ...
        if ($foto_diri == "" && $tdi == "") {
             $simpan = mysql_query("UPDATE tb_pendaftaran SET id_peserta='$id_peserta', no_ktp='$no_ktp', nama_peserta='$nama_peserta', jekel='$jekel', alamat='$alamat', no_hp='$no_hp', nama_perusahaan='$nama_perusahaan', produk='$produk', id_pelatihan='$id_jenispelatihan' WHERE id_peserta='$id'") or die(mysql_error());
        }elseif ($tdi == "") {
            ...
            $simpan = mysql_query("UPDATE tb_pendaftaran SET id_peserta='$id_peserta', no_ktp='$no_ktp', nama_peserta='$nama_peserta', jekel='$jekel', alamat='$alamat', no_hp='$no_hp', nama_perusahaan='$nama_perusahaan', produk='$produk', id_pelatihan='$id_jenispelatihan', foto_diri='$foto_diriup' WHERE id_peserta='$id'") or die(mysql_error());
        }elseif ($foto_diri == "") {
            ...
            $simpan = mysql_query("UPDATE tb_pendaftaran SET id_peserta='$id_peserta', no_ktp='$no_ktp', nama_peserta='$nama_peserta', jekel='$jekel', alamat='$alamat', no_hp='$no_hp', nama_perusahaan='$nama_perusahaan', produk='$produk', id_pelatihan='$id_jenispelatihan', tdi='$tdiup'  WHERE id_peserta='$id'") or die(mysql_error());
        }else{
            ...
            $simpan = mysql_query("UPDATE tb_pendaftaran SET id_peserta='$id_peserta', no_ktp='$no_ktp', nama_peserta='$nama_peserta', jekel='$jekel', alamat='$alamat', no_hp='$no_hp', nama_perusahaan='$nama_perusahaan', produk='$produk', id_pelatihan='$id_jenispelatihan', foto_diri='$foto_diriup', tdi='$tdiup' WHERE id_peserta='$id'") or die(mysql_error());
        }
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select class="form-control" name="id_jenispelatihan" value="<?php echo $data['nama_pelatihan']; ?>">
                      ...
                      <?php
                        $s_nama_pelatihan = mysql_query("SELECT * FROM tb_jenispelatihan inner join tb_pelatihan on tb_pelatihan.id_jenispelatihan=tb_jenispelatihan.id_jenispelatihan group by tb_jenispelatihan.nama_pelatihan") or die(mysql_error());
