...
if (isset($_POST['simpan'])) 
{
  ...
  $update_kuota=mysql_query("UPDATE tb_pelatihan SET kuota=kuota-1 WHERE id_jenispelatihan='$nama_pelatihan'") or die(mysql_error());
    ...
    <tr>
        ...
        <td width="66%">
          ...
          <select class="form-control" name="nama_pelatihan">
                  <option>Pilih*</option>
                  <?php
                    $s_pelatihan = mysql_query("SELECT tb_jenispelatihan.id_jenispelatihan, tb_jenispelatihan.nama_pelatihan FROM tb_jenispelatihan left join tb_pelatihan on tb_jenispelatihan.id_jenispelatihan=tb_pelatihan.id_jenispelatihan WHERE kuota > 0 and tb_pelatihan.id_pelatihan is null") or die(mysql_error());
