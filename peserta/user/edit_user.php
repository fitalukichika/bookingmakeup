...
if (isset($_POST['simpan'])) 
{
  ...
  if ($foto_cek == "") 
  {
    ...
    no_telp='$no_telp', username='$username', password='$password', status='$status' WHERE id_user='$id'") or die(mysql_error());
  }else 
  {
    ...
    $simpan = mysql_query("UPDATE tb_user SET nik='$nik', nama='$nama', jekel='$jekel', alamat='$alamat', 
    no_telp='$no_telp', username='$username', password='$password', foto='$foto', status='$status' WHERE id_user='$id'") or die(mysql_error());
  }
